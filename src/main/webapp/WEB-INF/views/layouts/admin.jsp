	...
	<%@ taglib uri="http://www.opensymphony.com/sitemesh/decorator" prefix="decorator" %>
		...
		<body>
			<style>
				...
				.DialogDetailsPay__Title-Image,
				.DialogDetailsPay__Image {
					flex-basis: 30%;
					text-align: center;
				}
				...
				.DialogDetailsPay__Title-BookName,
				.DialogDetailsPay__BookName {
					flex-basis: 30%;
					text-align: center;
				}

				.DialogDetailsPay__Title-Count,
				.DialogDetailsPay__Count {
					flex-basis: 20%;
					text-align: center;
				}

				.DialogDetailsPay__Title-Price,
					...
					<div class="DialogDeleteAccount">
						...
						<div class="DeleteAccount__Setting">
							<div class="DeleteAccount__Setting-details DeleteAccount__Setting-YES">
								Yes</div>
							<div class="DeleteAccount__Setting-details" onclick="closeDialogDeleteAccount()">No</div>
						</div>
					</div>
				</div>
